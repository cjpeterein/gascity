...
- Regression tests:
  ...
  - `examples/bd/dolt/dog_exec_scripts_test.go`: `TestPhantomDBScriptFlagsUndersizedManifest`, `TestPhantomDBScriptHonorsManifestThresholdOverride`
- Why this branch closes it:
  ...
  (`examples/bd/dolt/assets/scripts/mol-dog-phantom-db.sh`) now also flags any
